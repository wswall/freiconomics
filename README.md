## Contents
Assorted models developed alongside M.Sc. Economics program at Universität Freiburg. 
* __micro__: based on materials from Advanced Microeconomics I and II taught by Professor Dr. Germain Gaudin
  * `game_theory/elimination.py`: classes and functions for simulating strategic form games and solving through iterative elimination
  * `game_theory/extensive.py`: classes for generating and visualizing extensive form games
* __network_econ__: based on materials from Digital and Network Economics taught by Professor Dr. Germain Gaudin
